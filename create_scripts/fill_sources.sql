...
FROM '/data_for_sources/complete_craft_market_wide_20230730.csv'
DELIMITER ','
CSV header;
...
product_id, product_name, product_description, product_type, product_price)
FROM '/data_for_sources/complete_craft_market_masters_products_202305071535.csv'
DELIMITER ','
CSV header;
...
customer_id, customer_name, customer_address, customer_birthday, customer_email)
FROM '/data_for_sources/complete_craft_market_orders_customers_202305071535.csv'
DELIMITER ','
CSV header;
...
FROM '/data_for_sources/complete_craft_market_craftsmans_202305071534.csv'
DELIMITER ','
CSV header;
...
FROM '/data_for_sources/complete_craft_market_customers_202305071535.csv'
DELIMITER ','
CSV header;
...
FROM '/data_for_sources/complete_craft_market_orders_202305071535.csv'
DELIMITER ','
CSV header;
